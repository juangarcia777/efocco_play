...
<head>
	...
	<link href="<?php echo SISTEMA_AVA; ?>assets/css/baloon.css" rel="stylesheet" type="text/css">
...
<body>
	...
	<?php 
				...
				if($GerenteAva==0 && $name_page!='cadastra_nova_aula.php' && $name_page!='aloca_aula_turmas.php' && $name_page!='lista-aulas.php' && $name_page!='ordena_aulas.php'){
					$class='';	
				}				
	?>
