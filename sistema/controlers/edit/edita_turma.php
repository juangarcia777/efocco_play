...
$disciplinas = $_POST['disciplinas'];
	...
	$grava = $db->select("UPDATE turma SET trava_aulas='$trava_aulas',id_curso='$id_curso', coordenador_turma='$coordenador_turma', data_entrada='$data_entrada', nome='$nome', unidade='$unidade', periodo_letivo='$periodo_letivo' WHERE id='$id_turma' LIMIT 1");
