										...
										<div class="form-wrap">
											...
											<div class="col-md-4 col-sm-12 mt-5 mb-5">
												<div class="custom-control custom-checkbox">
													<label class="control-label mb-10">Deseja travar as aulas desta disciplina ?</label><br>
													<select name="trava_aulas" class="form-control" required>
														<option value="">SELECIONE</option>
														<option <?php echo ($linha['trava_aulas']==0)?'selected':''; ?> value="0">NÃO</option>
														<option <?php echo ($linha['trava_aulas']==1)?'selected':''; ?> value="1">SIM</option>
													</select>
												</div>
											</div>
