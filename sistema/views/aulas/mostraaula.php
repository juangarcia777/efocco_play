...
<div class="row">
		...
		<?php if(!empty($linha_aula['link_aovivo']) && ($linha_aula['data_final_link_aovivo']>=date("Y-m-d") || $linha_aula['data_final_link_aovivo']=='0000-00-00')){ ?>
	...
	<div class="col-md-12 mtop20" style="color: #000; margin-top: 30px;">
		<h5 class="titulo_aula_grande">Conteúdo da Aula</h5>	
