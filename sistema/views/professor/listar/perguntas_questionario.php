...
?>
			...
			<div class="page-wrapper">
				<div class="container-fluid">
					...
					<div class=" col-sm-12">
						<a href="nova_questao/<?php echo $id_questionario; ?>/<?php echo $id_aula; ?>" class="btn btn-success btn-anim pull-right"><i class="icon-plus"></i><span class="btn-text">Nova Questão</span></a>
					</div>	
											...
											<table class="table mb-0">
                                                ...
                                                $sea = $db->select("SELECT perguntas_questi.*, perguntas.*, perguntas.id AS id_perg, perguntas.pergunta, perguntas.peso FROM perguntas_questi 
                                                  ...
                                                  <td >
                                                  		...
                                                  		<a data-id="<?php echo $row['id_perg']; ?>" data-post="controlers/professor/deleta_pergunta.php" data-title="Confirma a exclusão do registro?" data-text="Todas as respostas dessa pergunta serão apagadas" data-return="perguntas_questionario/<?php echo $id_questionario; ?>/<?php echo $id_aula; ?>" data-opcao="0" onclick="javascript:void(0)" class="btn btn-danger btn-icon-anim btn-square apaga-elemento pull-right mr-10" ><i class="icon-trash"></i></a>


                                                  		<a href="edita_questao/<?php echo $id_questionario ?>/<?php echo $row['id_perg'] ?>/<?php echo $id_aula ?>" class="btn btn-default mr-10 btn-icon-anim btn-square pull-right"><i class="fa fa-pencil"></i></a>
