													...
													<div class="col-sm-12">
														<div class="row">
															<div class="col-sm-6">
																...
																<input type="text" class="form-control filled-input" value="<?php echo $linha_turma['nome']; ?>">
															</div>

															<div class="col-sm-6">
																<label class="control-label mb-10">Professor</label>
																<input type="text" class="form-control filled-input" value="<?php echo $_SESSION['nome_sisconnection_adm']; ?>">
															</div>
													...
													<?php
														...
														while ($linha_aluno = $db->expand($verifica_aluno)) {
															...
															echo '<tr>';
																...
																<a href="javascript:void(0)" class="btn btn-primary btn-icon-anim btn-square" style="float: right;"><i class="icon-eye"></i></a>
