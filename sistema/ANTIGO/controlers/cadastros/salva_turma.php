<?php
	...
	if ($db->rows($verifica)) {
		...
		$grava = $db->select("INSERT INTO turma (id_curso, data_entrada, nome, unidade, periodo_letivo, coordenador_turma) VALUES ('$id_curso', '$data_entrada', '$nome', '$unidade', '$periodo_letivo', '$coordenador_turma')");	
